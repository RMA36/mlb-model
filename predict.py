    ...
    for gpk, info in eligible_games:
        try:
            ...
            predictions.append({
                ...
                "pick_factors": {
                    "away_fi_runs_per_start": round(features.get("away_p_fi_runs_per_start", 0), 2),
                    "home_fi_runs_per_start": round(features.get("home_p_fi_runs_per_start", 0), 2),
                    "away_fi_k_rate": round(features.get("away_p_fi_k_rate", 0), 3),
                    "home_fi_k_rate": round(features.get("home_p_fi_k_rate", 0), 3),
                    "away_recent_fi_runs": round(features.get("away_p_recent_fi_runs", 0), 2),
                    "home_recent_fi_runs": round(features.get("home_p_recent_fi_runs", 0), 2),
                    "away_avg_velo": round(features.get("away_p_avg_velo", 0), 1),
                    "home_avg_velo": round(features.get("home_p_avg_velo", 0), 1),
                    "away_platoon_k_rate": round(features.get("away_p_platoon_k_rate", 0), 3),
                    "home_platoon_k_rate": round(features.get("home_p_platoon_k_rate", 0), 3),
